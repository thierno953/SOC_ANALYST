...
- [Velociraptor](https://github.com/Velocidex/velociraptor/releases/tag/v0.73)
- [Links Velociraptor](https://docs.velociraptor.app/downloads/)

```sh
root@server:/opt/velociraptor# wget https://github.com/Velocidex/velociraptor/releases/download/v0.73/velociraptor-v0.74.1-linux-amd64
...
```sh
root@client:/tmp# dpkg -i velociraptor_client_0.73.1_amd64.deb
root@client:/tmp# systemctl status velociraptor_client.service
```

![Velociraptor](/Velociraptor-Linux/assets/02.png)
