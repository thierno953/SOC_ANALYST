...
#### Installing Fleet on Windows Machine
...
```sh
PS C:\Users\Administrator\elastic-agent-8.x.x-windows-x86_64> .\elastic-agent.exe install --url=https://<IP_FLEET_SERVER>:8220 --enrollment-token --insecure
```
